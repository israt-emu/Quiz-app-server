...
exports.getSingleOrderService = exports.getOrdersService = exports.createOrderService = void 0;
...
const createOrderService = (payload, user) => __awaiter(void 0, void 0, void 0, function* () {
    if (!user.userId) {
...
const getSingleOrderService = (id, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!order) {
        throw new ApiError_1.ApiError(http_status_1.default.NOT_FOUND, "Order not found");
    }
